...
- (void)viewDidLoad {
    ...
    //热贴
    hotTableV = [[UITableView alloc]initWithFrame:CGRectMake(0, segmentView.bottom, kDeviceWidth, KDeviceHeight-(segmentView.height+kStatusBarHeight+kNavigationBarHeight))];
    ...
    //我关注的
    focusTableV = [[UITableView alloc]initWithFrame:CGRectMake(0, segmentView.bottom, kDeviceWidth, KDeviceHeight-(segmentView.height+kStatusBarHeight+kNavigationBarHeight))];
